...
const Home = (props: Props) => {
  ...
  <main className="row auth-screen">
    <div className="col-lg-5 sign-in-form pt-8">
         <LoginWithEmailPasscode signup={true}/>
    </div>
    <div className="col-lg-7 highlights align-self-center px-5 mt-3 d-none d-lg-block">
      ...
      <p className='subtitle font-light'>We help you create any type of designs, starting from ads for mobile, to slides for presentation.</p>
    </div>
  </main>
     </>
  )
